...
class Object2WithDefaultParameterAsPropertyTest {

    data class Input1(val value: String)
    data class Input2(val age: Int)
    data class Output(val value: String, val second: Input2)
    ...
    fun `map identical data classes with default parameter name should succeed`() {
        compile(directory) {
            file("Test.kt",
                ...
                import tech.mappie.testing.objects2.Object2WithDefaultParameterAsPropertyTest.*
