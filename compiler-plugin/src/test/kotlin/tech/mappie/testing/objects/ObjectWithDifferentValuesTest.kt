...
class ObjectWithDifferentValuesTest : MappieTestCase() {
    ...
    fun `map two data classes with the different values should fail`() {
        compile {
            ...
            isCompilationError()
            hasSingleErrorMessage(4, "Target(s) 'Output::name' has/have no source defined.")
        }
    }
        ...
        compile {
            ...
            hasErrorMessages(
                Triple(
                    ...
                    listOf(
                        "toString(): String:", "candidate(s): fun toString(): String",
                        "Any?.toString(): String:",
                        "candidate(s): fun Any?.toString(): String",
                    ),
                ),
                Triple(
                    7,
                    "Inapplicable candidate(s): fun toInt(): Int",
                    emptyList(),
                ),
            )
        }
