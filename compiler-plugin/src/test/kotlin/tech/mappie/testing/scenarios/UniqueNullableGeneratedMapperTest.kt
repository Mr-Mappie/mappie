...
class UniqueNullableGeneratedMapperTest : MappieTestCase() {

    // local model for Address DTOs
    ...
    data class ProjectInfo(
        ...
        val contactData: ContactDataInfo? = null
    )
    ...
    fun `two implicit mappie objects`() {
        compile {
            file("Test.kt",
                ...
                import tech.mappie.testing.scenarios.UniqueNullableGeneratedMapperTest.*
            ...
            val addressDto1 = GetProjectResultInnerAddress()
            ...
            val addressDto2 = GetProjectListResultItemInnerAddress()
    ...
    @Test
    fun `two mappie objects with helper mappies`() {
        compile {
            file("Test.kt",
                """
                import tech.mappie.api.ObjectMappie
