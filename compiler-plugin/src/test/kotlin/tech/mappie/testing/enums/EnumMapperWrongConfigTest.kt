...
class EnumMapperWrongConfigTest : MappieTestCase() {
    ...
    fun `declaring an EnumMappie with @UseDefaultArguments should warn`() {
        compile {
            ...
            isOk()
            hasSingleWarningMessage(5, "Annotation @UseDefaultArguments has no effect on subclass of EnumMappie")
        }
    }
    ...
    fun `declaring an EnumMappie with @UseStrictVisibility should warn`() {
        compile {
            ...
            isOk()
            hasSingleWarningMessage(5, "Annotation @UseStrictVisibility has no effect on subclass of EnumMappie")
        }
    }
