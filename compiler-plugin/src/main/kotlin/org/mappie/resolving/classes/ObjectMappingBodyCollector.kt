...
import org.mappie.resolving.*
import org.mappie.util.getterName
import org.mappie.util.irGet
import org.mappie.util.location
import org.mappie.util.logError
...
) : org.mappie.BaseVisitor<ObjectMappingsConstructor, ObjectMappingsConstructor>(file) {
...
private class ObjectBodyStatementCollector(
    file: IrFileEntry,
    private val dispatchReceiverSymbol: IrValueSymbol,
) : org.mappie.BaseVisitor<Pair<Name, ObjectMappingSource>?, Unit>(file) {
...
private class MapperReferenceCollector : org.mappie.BaseVisitor<IrFunctionExpression, Unit>() {
...
private class SourceValueCollector(
    private val dispatchReceiverSymbol: IrValueSymbol,
) : org.mappie.BaseVisitor<ObjectMappingSource, Unit>() {
...
private class TargetValueCollector(file: IrFileEntry) : org.mappie.BaseVisitor<Name, Unit>(file) {
