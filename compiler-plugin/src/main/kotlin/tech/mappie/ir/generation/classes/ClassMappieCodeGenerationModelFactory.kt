...
import tech.mappie.ir.generation.MappieIrGenerationProblems.MAPPIE_NO_IMPLICIT_MAPPING
    ...
    private fun generate(origin: InternalMappieDefinition, source: IrType, target: IrType): Pair<GeneratedMappieDefinition, CodeGenerationModel>? {
        ...
        selected.mappings
            ...
            .forEach { (_, _) ->
                context
                    .at(origin.clazz)
                    .report(MAPPIE_NO_IMPLICIT_MAPPING, source.dumpKotlinLike(), target.dumpKotlinLike())
            }
