...
//            val model = CodeGenerationModelFactory.of(request).construct(context.model.function)
...
//            val generated = clazz.transform(MappieTranformer(context.copy(model = model)), null)
