...
import tech.mappie.fir.analysis.MappieFirProblems.ANNOTATION_USE_STRICT_VISIBILITY_NOT_APPLICABLE
import tech.mappie.fir.util.isSubclassOfEnumMappie
import tech.mappie.util.CLASS_ID_USE_STRICT_VISIBILITY

class UseStrictVisibilityAnnotationChecker : FirAnnotationCallChecker(MppCheckerKind.Common) {
